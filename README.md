NMSProxy is an API and an internal hack, which allows for real-time manipulation of No Man's Sky, additional functionality to No Man's Sky & a wide variety of other features. 
